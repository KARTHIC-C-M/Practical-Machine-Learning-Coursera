...
Of the two Prediction Methods used in the study, accuracy was better for the  The Random Forest method since the Confusion Matrix achieves approximately only.
